...
class VisualGridHuntGame:
    ...
    def __init__(self, width=10, height=10, num_food=10, num_opponents=2, custom_walls=None):
        ...
        self.toxic_traps.update(random.sample(tuple(available_positions), min(3, len(available_positions))))
...
class GridGameGUI:
    ...
    def draw_grid(self):
        ...
        for tx, ty in self.env.toxic_traps:
            ...
            center_y = (self.env.height - 1 - ty + 0.5) * self.cell_size
            half_size = self.cell_size * 0.3
